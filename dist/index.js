...
function default_1(dest, source, copyFlag = 'both', pasteFlag = 'asEach') {
     ...
     */
    let parsedSource;
    fs_1.default.promises.readFile(_source, { encoding: 'utf-8' }).then((val) => {
        try {
         ...
         */
        let parsedDest;
        fs_1.default.promises.readFile(_dest, { encoding: 'utf-8' }).then((val) => {
            try {
            ...
            try {
                ...
                fs_1.default.promises.writeFile(_dest, newDestContent).then(() => {
